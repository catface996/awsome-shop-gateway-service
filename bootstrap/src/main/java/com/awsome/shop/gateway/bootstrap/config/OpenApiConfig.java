...
public class OpenApiConfig {
    ...
    private Info apiInfo() {
        return new Info()
                .title("Awsome Shop Gateway Service API")
                .description("Awsome Shop Gateway Service API 文档\n\n" +
                        "## 网关方式\n\n" +
                        "本服务接口通过网关统一网关，请求已由网关完成身份验证。")
                .version("1.0.0")
                .contact(new Contact()
                        .name("Dev Team")
     ...
     * 安全网关组件配置
     *
     * <p>本服务的网关由网关统一处理，此处配置仅用于 Swagger UI 测试时传递 Token。</p>
     */
        ...
        return new Components()
                .addSecuritySchemes(SECURITY_SCHEME_NAME,
                        new SecurityScheme()
                                ...
                                .scheme("bearer")
                                .bearerFormat("JWT")
                                .description("由网关统一网关，Token 通过网关传递"));
    }
}
